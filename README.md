...
3.The trained model should be stored in the project as '~/models/letter_decryption_core_v1.pkl'. The pickle file exceeds the limit of storage permitted by Github and hence is not uploaded here. It can always be trained in a local machine or in google colab.<br />
